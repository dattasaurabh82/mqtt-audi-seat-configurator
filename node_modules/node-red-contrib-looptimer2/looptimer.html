<script type="text/javascript">
	RED.nodes.registerType('looptimer2',{
...
<script type="text/x-red" data-template-name="looptimer2">
	<div class="form-row">
...
<script type="text/x-red" data-help-name="looptimer2">
        <p>Sends <code>msg</code> to the first output continually, once per specified time, till a msg with any topic of <code>stop</code> or <code>STOP</code> is received, at which time the second output will automatically send a payload of <code>stopped</code>.
